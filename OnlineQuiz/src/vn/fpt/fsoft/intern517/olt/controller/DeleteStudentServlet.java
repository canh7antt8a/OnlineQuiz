...
public class DeleteStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String classID = studentBO.getClassID(request
				.getParameter("deleteUserName"));
		studentBO.deleteStudent(request.getParameter("deleteUserName"));
		response.sendRedirect("ManageStudentServlet?classID=" + classID);
