...
<body style ="background-color: rgba(0,0,0,0.7)">
	...
	<form style ="padding-top: 30px" action="EditPasswordChildAdminServlet" method="post" id="editPass">
		<div class = "modal-content-info animate-noti">
			...
			<div class = "container-info">
				<p>
					...
					<input class="input-info" type = "password" name="oldPass" id="oldPass" maxlength="250">
